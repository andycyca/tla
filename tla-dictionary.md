...
(@) **[ISN]**:  
(@) **[ISO]**
: International Organization for Standardization (false acronym)
...
(@) **[LZV]**:  
(@) **[LZW]**
: Lempel–Ziv–Welch (algorithm in computer science)
...
(@) **[MLO]**:  
(@) **[MLP]**
: My Little Pony (media franchise)
...
(@) **[PNF]**:  
(@) **[PNG]**
: Portable Network Graphic (PNG's Not Gif)
...
(@) **[QEC]**:  
(@) **[QED]**
: Quod Erat Demostrandum (mathematics)
...
(@) **[QFS]**:  
(@) **[QFT]**
: Quadratic Frobenius test (mathematics)
: Quantitative Feedback Theory (control theory)
: Quantum Field Theory (physics)
: Quantum Fourier Transform (mathematics)
: Queen's Film Theatre (Northern Ireland)
: Question Formulation Technique (education)
: Quoted For Truth (internet forum parlance)
...
(@) **[TFB]**:  
(@) **[TFC]**
: Team Fortress Classic (videogame)
(@) **[TFD]**:  
(@) **[TFE]**:  
(@) **[TFF]**:  
(@) **[TFG]**:  
...
(@) **[VHR]**:  
(@) **[VHS]**
: Video Home System (video format)
